        ...
        <label htmlFor={id} className={`flex items-center gap-2 cursor-pointer ${className}`}>
            <div className="relative">
                <input
                    ...
                    checked={checked}
                    onChange={onChange}
                    className="peer h-5 w-5 appearance-none rounded-md border-2 border-orange-300 transition-all checked:border-orange-500 checked:bg-orange-500 hover:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:ring-offset-0 cursor-pointer"
                />
            ...
            {label && (
                <span className="select-none text-sm text-orange-700 font-medium">
                    {label}
                </span>
            )}
        </label>
