    ...
    const renderCalendarDays = () => {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            const getBgColor = () => {
                ...
                if (insulinLevel === 'low') return 'bg-teal-50';
                if (insulinLevel === 'medium') return 'bg-yellow-50';
                if (insulinLevel === 'high') return 'bg-teal-50';
                return 'bg-gray-50';
            };

            const getBorderColor = () => {
                if (isToday) return 'border-green-500';
                if (insulinLevel === 'low') return 'border-teal-300';
                if (insulinLevel === 'medium') return 'border-yellow-300';
                if (insulinLevel === 'high') return 'border-teal-300';
                return 'border-gray-100';
            };

            const getHoverBorderColor = () => {
                if (isToday) return 'hover:border-green-500';
                if (insulinLevel === 'low') return 'hover:border-teal-500';
                if (insulinLevel === 'medium') return 'hover:border-yellow-500';
                if (insulinLevel === 'high') return 'hover:border-teal-500';
                            ...
                            <div className="flex flex-col items-end">
                                <motion.div
                                    ...
                                    className={`
                                        ...
                                        ${insulinLevel === 'low' ? 'bg-teal-100 text-teal-600' : ''}
                                        ${insulinLevel === 'medium' ? 'bg-yellow-100 text-yellow-600' : ''}
                                        ${insulinLevel === 'high' ? 'bg-teal-100 text-teal-600' : ''}
                    ...
                    >
                        ...
                        {!recommendation ? (
                            ...
                            <form onSubmit={handleAddSubmit} className="p-4 space-y-4">
                                ...
                                <div className={`p-4 rounded-lg ${canTrustResult ? 'bg-green-50' : 'bg-teal-50'} mb-4`}>
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h3 className={`font-medium ${canTrustResult ? 'text-green-800' : 'text-teal-800'}`}>
                                            ...
                                            <div className="mt-2 text-xs">
                                                <div className={`flex items-center gap-1 ${canTrustResult ? 'text-green-600' : 'text-teal-600'}`}>
                            ...
                            <div className="space-y-3 max-h-96 overflow-y-auto">
                                {dayLogs.map((log) => {
                                    const getLogColor = (dosage: number) => {
                                        ...
                                        if (dosage >= 3) return 'bg-teal-100 text-teal-600';
