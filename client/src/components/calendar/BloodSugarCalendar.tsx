...
export default function BloodSugarCalendar({ 
  ...
  const getValueColor = (value: number) => {
    if (value < 70) return 'text-teal-600 bg-teal-100'; // Low
    if (value > 180) return 'text-teal-600 bg-teal-100'; // High
          ...
          <div className="flex justify-between items-start">
            ...
            {count > 0 && (
              <div className="flex flex-col items-end">
                ...
                <span className={`text-xs ${count < 5 ? 'text-teal-500' : 'text-gray-500'} mt-1`}>
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          <div className="flex items-center justify-center gap-6 text-sm">
            ...
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-teal-100 border border-teal-600" />
