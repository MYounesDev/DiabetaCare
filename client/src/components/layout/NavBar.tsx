        ...
        <AnimatePresence>
          {dropdownOpen && (
            ...
            >
              ...
              <button
                className="w-full flex items-center gap-3 px-5 py-3 hover:bg-teal-50 text-teal-600 transition-colors border-t border-green-100"
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-4">
                <AlertCircle size={40} className="text-teal-500 mb-2" />
                <h2 className="text-2xl font-bold text-teal-700 mb-2">Confirm Logout</h2>
                ...
                <div className="flex gap-4 w-full">
                  ...
                  <button
                    className="flex-1 py-2 rounded-lg bg-gradient-to-r from-teal-500 to-rose-500 text-white font-semibold hover:from-teal-600 hover:to-rose-600 transition-all"
