        ...
        <div className="flex min-h-screen">
          <div className="flex-1 p-8 bg-gradient-to-br from-green-50 to-teal-100">
            ...
            {loading ? (
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-xl p-6 flex items-start">
                <AlertCircle className="text-teal-500 mr-4" size={24} />
                <div>
                  <h3 className="text-teal-800 font-semibold">Error</h3>
