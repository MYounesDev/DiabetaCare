          ...
          <div className="flex-1 p-8 bg-gradient-to-br from-green-50 to-teal-100">
            ...
            {loading ? (
              ...
              <motion.div
                ...
                className="bg-teal-50 border-l-4 border-teal-500 p-6 rounded-lg shadow-md"
              >
                <div className="flex items-center gap-3">
                  <AlertCircle className="text-teal-500" size={24} />
                  <h2 className="text-xl font-semibold text-teal-700">Error</h2>
                </div>
                <p className="mt-2 text-teal-600">{error}</p>
                <button
                  onClick={() => fetchPatients()}
                  className="mt-4 px-4 py-2 bg-teal-100 hover:bg-teal-200 text-teal-700 rounded-md transition-colors"
                >
                  Try Again
                </button>
              </motion.div>
                        ...
                        <div className="flex justify-between pt-4 border-t border-gray-100">
                          ...
                          <div className="flex space-x-2">
                            ...
                            <button
                              ...
                              className="p-1 rounded-full hover:bg-teal-50 text-teal-500"
                            >
                              <Trash2 size={18} />
                            </button>
                          </div>
