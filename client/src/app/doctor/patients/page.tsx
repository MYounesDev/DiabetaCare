                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          <div className="flex items-center">
                            ...
                            <div>
                              <h3 className="font-bold text-lg text-orange-800">{patient.full_name}</h3>
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex items-center text-gray-600">
                            <UserCircle size={16} className="mr-2 text-orange-600" />
                        ...
                        <div className="flex justify-between pt-4 border-t border-gray-100">
                          ...
                          <div className="flex space-x-2">
                            <button
                              ...
                              className="p-1 rounded-full hover:bg-orange-50 text-orange-600"
                            >
                              <Edit size={18} />
                            </button>
                            <button
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-orange-50">
                      <tr>
                        ...
                        <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-orange-800 uppercase tracking-wider">
                          Actions
                        </th>
                      </tr>
                    </thead>
