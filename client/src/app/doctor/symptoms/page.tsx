    ...
    <PageTemplate>
      <AuthWrapper allowedRoles={["doctor"]}>
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 p-8">
          {/* Header Section */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-orange-800 mb-2">Symptoms Management</h1>
          ...
          <div className="grid grid-cols-1 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-bold text-orange-800">Symptoms Types</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-200">
                <div className="flex justify-between items-center">
                  <div>
                    <h2 className="text-xl font-bold text-orange-800">Patient Symptoms</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 lg:col-span-2">
                  <h3 className="text-lg font-semibold text-orange-800 mb-4">Symptoms History</h3>
                  {selectedPatientId ? (
                        ...
                        {patientSymptoms.map(symptom => (
                          ...
                          >
                            <div className="flex justify-between items-start">
                              <div>
                                <h4 className="font-medium text-orange-800">{symptom.symptom_name}</h4>
          ...
          <div className="fixed inset-0 backdrop-blur-sm bg-orange-900/10 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-200 p-4 bg-orange-50">
                <h2 className="text-xl font-bold text-orange-800">Add New Symptom</h2>
                <button onClick={() => setShowAddSymptomModal(false)} className="p-1 rounded-full hover:bg-orange-100 text-orange-600">
                  <X size={20} />
                </button>
              </div>
        ...
        {showEditSymptomModal && selectedSymptom && (
          <div className="fixed inset-0 backdrop-blur-sm bg-orange-900/10 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-200 p-4 bg-orange-50">
                <h2 className="text-xl font-bold text-orange-800">Edit Symptom</h2>
                <button onClick={() => setShowEditSymptomModal(false)} className="p-1 rounded-full hover:bg-orange-100 text-orange-600">
                  <X size={20} />
                </button>
              </div>
              <form onSubmit={async (e) => {
        ...
        {showDeleteSymptomModal && selectedSymptom && (
          <div className="fixed inset-0 backdrop-blur-sm bg-orange-900/10 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-200 p-4 bg-orange-50">
                <h2 className="text-xl font-bold text-orange-800">Delete Symptom</h2>
                <button onClick={() => setShowDeleteSymptomModal(false)} className="p-1 rounded-full hover:bg-orange-100 text-orange-600">
                  <X size={20} />
                </button>
              </div>
              <div className="p-4">
                <p className="mb-4 text-orange-700">Are you sure you want to delete <span className="font-semibold text-red-600">{selectedSymptom.symptom_name}</span>?</p>
                {symptomFormError && (
                  <div className="bg-red-50 text-red-600 p-3 rounded-lg text-sm flex items-center gap-2">
                    <AlertCircle size={16} /> {symptomFormError}
                  </div>
        ...
        {showAddPatientSymptomModal && (
          <div className="fixed inset-0 backdrop-blur-sm bg-orange-900/10 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-200 p-4 bg-orange-50">
                <h2 className="text-xl font-bold text-orange-800">Add Patient Symptom</h2>
                <button onClick={() => setShowAddPatientSymptomModal(false)} className="p-1 rounded-full hover:bg-orange-100 text-orange-600">
                  <X size={20} />
                </button>
              </div>
              <form onSubmit={handleAddPatientSymptom} className="p-4 space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-orange-700 mb-1">Symptom Type</label>
                  <select
                    required
        ...
        {showDeletePatientSymptomModal && selectedPatientSymptom && (
          <div className="fixed inset-0 backdrop-blur-sm bg-orange-900/10 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-200 p-4 bg-orange-50">
                <h2 className="text-xl font-bold text-orange-800">Delete Patient Symptom</h2>
                <button onClick={() => setShowDeletePatientSymptomModal(false)} className="p-1 rounded-full hover:bg-orange-100 text-orange-600">
                  <X size={20} />
                </button>
              </div>
              <div className="p-4">
                <p className="mb-4 text-orange-700">Are you sure you want to delete this symptom record?</p>
                {patientSymptomFormError && (
                  <div className="bg-red-50 text-red-600 p-3 rounded-lg text-sm flex items-center gap-2">
                    <AlertCircle size={16} /> {patientSymptomFormError}
                  </div>
