    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                const fetchSymptoms = await doctorService.getRecentSymptoms();
            ...
            <AuthWrapper allowedRoles={['doctor', 'admin']} >
                <div className="flex min-h-screen">
                    <div className="flex-1 p-8 bg-gradient-to-br from-orange-50 to-red-100">
                        <h1 className="text-3xl font-bold text-orange-800 mb-8">Doctor Dashboard</h1>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
                            ...
                            >
                                <div className="p-3 rounded-full text-orange-500 bg-opacity-20">
                                    <Users size={24} />
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Total Patients</p>
                                    <p className="text-2xl font-bold text-orange-700">{totalPatients}</p>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                className="bg-white rounded-xl shadow-md p-6 flex items-center gap-4 hover:shadow-lg transition-shadow"
                            >
                                <div className="p-3 rounded-full text-red-500 bg-opacity-20">
                                    <ClipboardList size={24} />
                                </div>
                                <div>
                                    <p className="text-sm text-gray-500">Pending Exercises</p>
                                    <p className="text-2xl font-bold text-orange-700">{patientExercises}</p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-orange-700">{dietPlans}</p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-orange-700">{totalSymptoms}</p>
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-orange-700">{bloodSugarAlerts}</p>
                                </div>
                            </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                            ...
                            >
                                <h2 className="text-xl font-semibold text-orange-700 mb-4">Patient Activity</h2>
                                <Bar
                            ...
                            <motion.div
                                ...
                                className="bg-white rounded-xl shadow-md p-6"
                            >
                                <h2 className="text-xl font-semibold text-orange-700 mb-4">Blood Sugar Trends</h2>
                                <Line
                        ...
                        <motion.div
                            ...
                            className="bg-white rounded-xl shadow-md p-6"
                        >
                            <h2 className="text-xl font-semibold text-orange-700 mb-4">Recent Activity</h2>
                            <div className="space-y-4">
                                <div className="flex items-center gap-3 p-3 border-b border-gray-100">
                                    <Activity className="text-orange-500" size={20} />
                                    <p className="text-orange-800">Patient <span className="font-medium">John Doe</span> completed their exercise plan</p>
                                </div>
                                <div className="flex items-center gap-3 p-3 border-b border-gray-100">
                                    <Activity className="text-orange-500" size={20} />
                                    <p className="text-orange-800">Patient <span className="font-medium">Jane Smith</span> reported total symptoms</p>
                                </div>
                                <div className="flex items-center gap-3 p-3">
                                    <Activity className="text-orange-500" size={20} />
                                    <p className="text-orange-800">Patient <span className="font-medium">Mike Johnson</span> has high blood sugar levels</p>
                                </div>
                            </div>
                        </motion.div>
                        </>
