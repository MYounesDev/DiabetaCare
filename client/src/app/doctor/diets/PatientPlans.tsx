  ...
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-4 border-b border-gray-200">
        <h2 className="text-xl font-bold text-green-800">Diet Plans</h2>
      </div>
            ...
            {plans.map(plan => (
              <div
                ...
                className={`p-4 transition-colors hover:bg-green-50 cursor-pointer ${
                  selectedPlanId === plan.diet_logs_id ? 'bg-green-50 border-l-4 border-green-500' : ''
                }`}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-semibold text-green-800">{plan.diet_name}</h3>
